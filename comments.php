...
<form class="ts form" id="commentform" name="commentform" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" data-dark>
    ...
    <?php endif; ?>
    <div class="resizable field"><div class="ts fluid input" data-dark>
    ...
    <a href="javascript:void(0);" onClick="Javascript:document.forms['commentform'].submit()" class="ts fluid bottom button" data-dark><?php esc_html_e( 'Leave a comment', 'Carter' ); ?></a> 
